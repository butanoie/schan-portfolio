...
export const resumeData: ResumeData = {
  ...
  jobs: [
    {
      ...
      keyContributions: [
        ...
        "Collaborated with engineering teams on product backlog definition and sprint planning",
        "Managed QA engineering team in developing comprehensive test cases and automation frameworks to maintain product quality standards",
        "Partnered with cloud operations to monitor system health and ensure platform reliability",
        ...
        "Mentored UX developers, fostering design excellence and cross-functional collaboration",
        "Designed and delivered product knowledge onboarding program for new Collabware team members",
      ],
    },
    {
  ...
  speaking: {
    ...
    events: [
      {
        conference: "ARMA Canada 2021 Information Conf",
        year: "2021",
      },
      {
        conference: "ARMA Houston 2021 Spring Conf",
        year: "2021",
      },
      {
        conference: "SharePoint Saturday, Vancouver",
        year: "2009",
      },
      {
        conference: "DevTeach, Vancouver",
        year: "2009",
      },
      {
        conference: "TechDays, Vancouver",
        year: "2009",
      },
      {
        conference: "EnergizeIT, Toronto",
        year: "2007",
      },
    ],
  },
